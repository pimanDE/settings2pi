...
sudo sqlite3 /etc/pihole/gravity.db "Insert into domainlist (type, domain, enabled, comment) values (3,'.cd$',1,'Domains aus Republik Kongo');"
...
sudo sqlite3 /etc/pihole/gravity.db "Insert into domainlist (type, domain, enabled, comment) values (3,'.su$',1,'Domains aus Sowjetunion');"
sudo sqlite3 /etc/pihole/gravity.db "Insert into domainlist (type, domain, enabled, comment) values (3,'.tk$',1,'Domains aus Tokelau');"
sudo sqlite3 /etc/pihole/gravity.db "Insert into domainlist (type, domain, enabled, comment) values (3,'.ua$',1,'Domains aus Ukraine');"
